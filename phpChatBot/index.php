...
<html lang="en">
   ...
   <body style="background-color: #c060a1"">
            ...
            <div class="col-md-6">
               ...
               <div class="card ">
                  <div class="card messages-box ">
					 <ul class="list-unstyled messages-list bot">
							<?php
                  ...
                  <div class="card-header">
                    <div class="input-group">
					   <input id="input-me" type="text" name="messages" class="form-control input-sm" placeholder="use # before requested song" />
			...
			if(txt){
				jQuery.ajax({
					...
					success:function(result){
						var html='<li class="messages-you clearfix"><span class="message-img"><img src="image/bot.png" class="avatar-sm rounded-circle"></span><div class="message-body clearfix"><div class="message-header"><strong class="messages-title">Rythm</strong> <small class="time-messages text-muted"><span class="fas fa-time"></span> <span class="minutes">'+getCurrentTime()+'</span></small> </div><p class="messages-p">'+result+'</p></div></li>';
						jQuery('.messages-list').append(html);
